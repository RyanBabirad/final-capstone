...
public class MaintenanceRequestsController {
    ...
    @RequestMapping(path = "/staff/maintenance-request", method = RequestMethod.POST)
    ...
    @RequestMapping(path = "/staff/maintenance-request/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/staff/maintenance-request/{id}", method = RequestMethod.PUT)
    ...
    @RequestMapping(path = "/staff/maintenance-request/{id}", method = RequestMethod.DELETE)
