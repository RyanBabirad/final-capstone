<template>
  <section
    ...
    :style="{ height: showForm ? 'auto' : '30%' }"
  >
    <div class="status-message success" v-show="successMsg !== ''">
      {{ successMsg }}
    </div>
    <div class="status-update-container">
      ...
      <br />
      <button @click="toggleForm" class="updateAccountButton" type="submit">
        Update Account
      </button>
    </div>
    <br />
...
export default {
  ...
  methods: {
    ...
    async submitUser() {
      ...
      await UserService.updateRole(newUser);
